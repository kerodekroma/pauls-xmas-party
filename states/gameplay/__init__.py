...
class GamePlayState(game_state.GameState):
    def __init__(self, state_manager):
        ...
        self.angle = 0
        self.header = GamePlayHeader(( settings.WINDOW_WIDTH, 6 * unit ), ( 0, 0 ), self.palette[3])
        self.board = GamePlayBoardOfCards((settings.WINDOW_WIDTH, 10), (0, settings.HEADER_HEIGHT), settings)
